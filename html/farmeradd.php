...
?>
            ...
            <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Farmer/</span> Add Farmer</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <!-- Account -->
                                    <form  method="POST" action="addfarmer.php" enctype="multipart/form-data" >
                                    <hr class="my-0" />
                                    <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    <label for="lastName" class="form-label">Agent Name</label>
                                                    <select name="Type" class="select2 form-select">>
                                                        <option value="Client">Agent 1</option>
                                                        <option value="Farmer">Agent 2</option>
                                                    </select>
                                                </div>


                                                <div class="mb-3 col-md-6">
                                                    <label for="organization" class="form-label">Member Since</label>
