...
<div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sales/</span> Sales Rate</h4>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card mb-4">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    <label for="lastName">Agent Name</label>
                                        ...
                                        <tr>
                                            ...
                                            <td>cheese</td>
                                            <td>1kg</td>
                                            <td><div contenteditable class="form-control"></div></td> 
                                        </tr>
                                        </thead>
