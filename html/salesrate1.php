        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <form action="saverate.php" method="post">
                    <div class="col-md-9" style="margin-right: auto;margin-left: auto;">
                        <div class="card mb-4">

                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="exampleDataList" class="form-label">Select or Type Agent Name</label>
                                    <input
                                            class="form-control"
                                    ...
                                    <datalist id="datalistOptions">
                                        ...
                                        while ($data = mysqli_fetch_array($result)) {
                                        ?>
                                        <option value="<?php echo $data['Name']; ?>"><?php echo $data['Address']; ?>, <?php echo $data['Contact']; ?></option>
                                            <?php
                                        }
                    ...
                    <div class="row">
                        <div class="card">
                            ...
                            <h5 class="card-header">Add all rate and Submit <button type="button" class="btn btn-icon btn-primary" data-bs-toggle="tooltip"
                                                                                    data-bs-offset="0,4"
                                                                                    data-bs-placement="left"
                                                                                    data-bs-html="true"
                                                                                    title="<strong>Click here to Add New Product</strong>"  style="float:right;">
                                    <a href="#" data-bs-toggle="modal"
                                       data-bs-target="#modalCenter" >
                                    <span class="tf-icons bx bx-plus" style="color: white"></span></a>
                                </button></h5>
                            <div class="table-responsive text-nowrap">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <input type="hidden" name="Unit[<?php echo $data['Id']; ?>]" value="<?php echo $data['Unit']; ?>"/>

                                        <td class="input-group input-group-merge" style="max-width: 250px;">

                                            <input
                                                    type="text"
                                                    class="form-control"
                                                    value="<?php echo $data['Rate']; ?>"
                                                    name="Rate[<?php echo $data['Id']; ?>]"
                                            />
                                            <span class="input-group-text" id="basic-addon-search31">/<?php echo $data['Unit']; ?></span>
                                        </td>
                            ...
                            <br>
                            <button class="btn btn-primary btn-lg" type="submit" name="submit">Button</button>
<br>
                        </div>
                    </div>
                    </form>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalCenterTitle">New Product Adding Form</h5>
                <button
                        type="button"
                        class="btn-close"
            ...
            <div class="modal-body">
                ...
                <div class="row g-2">
                    ...
                    <div class="col mb-0">
                        <label for="dobWithTitle" class="form-label">Unit</label>
                        <select
                                type="text"
                                id="dobWithTitle"
                                class="form-control"
